            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed max-w-xl font-medium">
                  Chat with our AI eye-care assistant for instant advice, book smart appointments, and
                  get personalized vision care recommendations. Available 24/7.
                </p>
              </div>
