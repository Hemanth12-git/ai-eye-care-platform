...
function AppointmentConfirmationEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>Your eye appointment has been confirmed</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={logoContainer}>
            <Img
              ...
              style={logo}
            />
            <Text style={logoText}>EyeWise</Text>
          </Section>
          ...
          <Text style={text}>
            Your eye appointment has been successfully booked. Here are the details:
          </Text>
          ...
          <Section style={appointmentDetails}>
            ...
            <Text style={detailValue}>Eye Center</Text>
          </Section>
          ...
          <Text style={footerText}>
            If you have any questions, please contact us at support@eyewise.com
          </Text>
        </Container>
      </Body>
    </Html>
