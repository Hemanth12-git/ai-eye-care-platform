  ...
  if (isLoading)
    return (
      <div className="space-y-6">
        <h2 className="text-2xl font-semibold">Choose Your Eye Doctor</h2>
        <DoctorCardsLoading />
      </div>
    );
          ...
          >
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <CardDescription className="text-primary font-medium">
                    {dentist.speciality || "General Optometry"}
                  </CardDescription>
            ...
            <CardContent className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                {dentist.bio || "Experienced eye-care professional providing quality care."}
              </p>
